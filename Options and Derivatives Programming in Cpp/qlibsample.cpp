...
void testingBlackScholesCalculator ()
{
   ...
   boost::shared_ptr <PlainVanillaPayoff > vanillaPayoffPut(new QuantLib::PlainVanillaPayoff(Option::Put,K));
   boost::shared_ptr<AssetOrNothingPayoff> aonPayoffCall(new AssetOrNothingPayoff(QuantLib::Option::Call,K));
